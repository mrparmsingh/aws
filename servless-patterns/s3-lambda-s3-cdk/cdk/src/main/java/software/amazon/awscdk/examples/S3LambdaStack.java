    ...
    static class S3NotificationsLambda extends Construct {
        S3NotificationsLambda(
            ...
            PolicyStatement statement1 = PolicyStatement.Builder.create()
                    .effect(Effect.ALLOW)
                    .actions(Arrays.asList("s3:GetBucket", "s3:PutObject"))
                    .resources(Arrays.asList("arn:aws:s3:::" + bucketName.getBucketName() + "/*")).build();
            ...
            PolicyStatement statement3 = PolicyStatement.Builder.create()
                    ...
                    .resources(Arrays.asList("arn:aws:s3:::" + s3.getBucketName() + "/*")).build();
